...
session<-"V10" #prefix for output .xlsx
...
#hard code
  data[ data$Analysis == 12844 , "Identifier1"] <-  "empty"
  data[ data$Analysis == 12844 , "mass"] <- "0"
  data[ data$Analysis == 12844 , "carousel"] <-  "4"
  data[ data$Analysis == 12844 , "type"] <-  "empty"
  
  data[ data$Analysis == 12845 , "Identifier1"] <-  "SH1-OG019 (Decalc)"
  data[ data$Analysis == 12845 , "mass"] <- "40032"
  data[ data$Analysis == 12845, "carousel"] <-  "5"
  data[ data$Analysis == 12845 , "type"] <-  "sample"
  
  data[ data$Analysis == 12846 , "Identifier1"] <-  "SH1-OG024 (Kerogen)"
  data[ data$Analysis == 12846 , "mass"] <- "39995"
  data[ data$Analysis == 12846, "carousel"] <-  "6"
  data[ data$Analysis == 12846 , "type"] <-  "sample"
  
  data[ data$Analysis == 12847 , "Identifier1"] <-  "SH1-OG024 (Kerogen)"
  data[ data$Analysis == 12847 , "mass"] <- "39997"
  data[ data$Analysis == 12847, "carousel"] <-  "7"
  data[ data$Analysis == 12847 , "type"] <-  "sample"
  
  data[ data$Analysis == 12848 , "Identifier1"] <-  "SH1-OG024 (Kerogen)"
  data[ data$Analysis == 12848 , "mass"] <- "40085"
  data[ data$Analysis == 12848, "carousel"] <-  "8"
  data[ data$Analysis == 12848 , "type"] <-  "sample"
  
  data[ data$Analysis == 12849 , "Identifier1"] <-  "LOS"
  data[ data$Analysis == 12849 , "mass"] <- "38169"
  data[ data$Analysis == 12849, "carousel"] <-  "9"
  data[ data$Analysis == 12849 , "type"] <-  "mon.std"
  
  data[ data$Analysis == 12850 , "Identifier1"] <-  "L.glut"
  data[ data$Analysis == 12850 , "mass"] <- "520"
  data[ data$Analysis == 12850, "carousel"] <-  "10"
  data[ data$Analysis == 12850 , "type"] <-  "drift.std"
  
  data[ data$Analysis == 12851 , "Identifier1"] <-  "blank"
  data[ data$Analysis == 12851 , "mass"] <- "0"
  data[ data$Analysis == 12851, "carousel"] <-  "11"
  data[ data$Analysis == 12851 , "type"] <-  "blank"
  
  data[ data$Analysis == 12852 , "Identifier1"] <-  "OG015 (w/calc)"
  data[ data$Analysis == 12852 , "mass"] <- "40074"
  data[ data$Analysis == 12852, "carousel"] <-  "12"
  data[ data$Analysis == 12852 , "type"] <-  "sample"
  
  data[ data$Analysis == 12853 , "Identifier1"] <-  "OG015 (w/calc)"
  data[ data$Analysis == 12853 , "mass"] <- "40036"
  data[ data$Analysis == 12853, "carousel"] <-  "13"
  data[ data$Analysis == 12853 , "type"] <-  "sample"
  
  data[ data$Analysis == 12854 , "Identifier1"] <-  "OG015 (w/calc)"
  data[ data$Analysis == 12854 , "mass"] <- "39985"
  data[ data$Analysis == 12854, "carousel"] <-  "14"
  data[ data$Analysis == 12854 , "type"] <-  "sample"
  
  data[ data$Analysis == 12855 , "Identifier1"] <-  "OG005 (w/calc)"
  data[ data$Analysis == 12855 , "mass"] <- "4000"
  data[ data$Analysis == 12855, "carousel"] <-  "15"
  data[ data$Analysis == 12855 , "type"] <-  "sample"
  
  data[ data$Analysis == 12856 , "Identifier1"] <-  "OG005 (w/calc)"
  data[ data$Analysis == 12856 , "mass"] <- "40022"
  data[ data$Analysis == 12856, "carousel"] <-  "16"
  data[ data$Analysis == 12856 , "type"] <-  "sample"
  
  data[ data$Analysis == 12857 , "Identifier1"] <-  "OG005 (w/calc)"
  data[ data$Analysis == 12857 , "mass"] <- "40047"
  data[ data$Analysis == 12857, "carousel"] <-  "17"
  data[ data$Analysis == 12857 , "type"] <-  "sample" 
  
  data[ data$Analysis == 12858 , "Identifier1"] <-  "LOS"
  data[ data$Analysis == 12858 , "mass"] <- "38167"
  data[ data$Analysis == 12858, "carousel"] <-  "18"
  data[ data$Analysis == 12858 , "type"] <-  "mon.std"  

  data[ data$Analysis == 12859 , "Identifier1"] <-  "L.glut"
  data[ data$Analysis == 12859 , "mass"] <- "527"
  data[ data$Analysis == 12859, "carousel"] <-  "19"
  data[ data$Analysis == 12859 , "type"] <-  "drift.std"  
  
  data[ data$Analysis == 12860 , "Identifier1"] <-  "OG019 (w/calc)"
  data[ data$Analysis == 12860 , "mass"] <- "40046"
  data[ data$Analysis == 12860, "carousel"] <-  "20"
  data[ data$Analysis == 12860 , "type"] <-  "sample"  
  
  data[ data$Analysis == 12861 , "Identifier1"] <-  "OG019 (w/calc)"
  data[ data$Analysis == 12861 , "mass"] <- "40012"
  data[ data$Analysis == 12861, "carousel"] <-  "21"
  data[ data$Analysis == 12861 , "type"] <-  "sample"  
  
  data[ data$Analysis == 12862 , "Identifier1"] <-  "OG019 (w/calc)"
  data[ data$Analysis == 12862 , "mass"] <- "40039"
  data[ data$Analysis == 12862, "carousel"] <-  "22"
  data[ data$Analysis == 12862 , "type"] <-  "sample"  
  
  data[ data$Analysis == 12863 , "Identifier1"] <-  "L.glut"
  data[ data$Analysis == 12863 , "mass"] <- "526"
  data[ data$Analysis == 12863, "carousel"] <-  "23"
  data[ data$Analysis == 12863 , "type"] <-  "drift.std"  
  
  data[ data$Analysis == 12864 , "Identifier1"] <-  "Acet. #1"
  data[ data$Analysis == 12864 , "mass"] <- "504"
  data[ data$Analysis == 12864, "carousel"] <-  "24"
  data[ data$Analysis == 12864 , "type"] <-  "dis.std"  
...
C.acc.mon <- -27.34 
C.per.mon <- 1.66
N.acc.mon <- 6.25 #fom VanOosten's run on 20180419; corrected 0.5 per mil 
N.per.mon <- 0.133
...
stds.to.cull <- c(51, 45, 37, 36, 26, 7, 27, 28, 50, 38) #51 - 7 for d15N; 28, 27, 50 for d13C; 37 for area44; 38 is blank that needs peak ID
...
blanks<-subset(data, type=="blank") %>% filter(row != "38") #that blank N peak was not identified
