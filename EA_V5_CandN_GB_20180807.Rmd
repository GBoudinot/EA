...
session<-"V11" #prefix for output .xlsx
...
raw.data<- transform(raw.data, "Analysis" = as.numeric(`Analysis`)) %>% filter(Analysis > 13636) 
...
data <- data %>% filter(Analysis != 13660) %>% filter(Analysis != 13661) %>% filter(Analysis != 13662) %>% filter(Analysis != 13663) %>% filter(Analysis != 13664) %>% filter(Analysis != 13665) %>% filter(Analysis != 13666) %>% filter(Analysis != 13667) %>% filter(Analysis != 13668)
...
stds.to.cull <- c(9, 28, 38) #28 for C, 38 for N, 9 for both
...
assessmentC <-
  ...
  filter(Identifier1 != "blank") %>% filter(Identifier1 != "OG 05-D")%>% filter(Identifier1 != "OG 06-D")%>% filter(Identifier1 != "OG 43-D") %>%
...
CO2 <- assessmentC %>% 
  filter(Identifier1 != c("blank", "empty")) %>%
  ggplot() + 
